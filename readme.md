...
Cloudflare Workers is a serverless platform for building, deploying, and scaling applications across Cloudflare's global network. This list focuses on maintained resources that materially support the Workers runtime and Developer Platform.

## Contents

- [Official Resources](#official-resources)
- [Core Development and Testing](#core-development-and-testing)
- [Frameworks and Adapters](#frameworks-and-adapters)
- [Platform Libraries](#platform-libraries)
- [AI and Isolated Execution](#ai-and-isolated-execution)
...
- [Cloudflare TypeScript SDK](https://github.com/cloudflare/cloudflare-typescript) - Official API client for managing Workers scripts, versions, deployments, and other Cloudflare resources.
- [Drizzle ORM](https://github.com/drizzle-team/drizzle-orm) - Type-safe ORM and migration tooling with D1 support.
- [postal-mime](https://github.com/postalsys/postal-mime) - MIME parser suitable for Email Workers.
...
- [Pulumi Cloudflare Provider](https://github.com/pulumi/pulumi-cloudflare) - Multi-language infrastructure-as-code provider for Workers and Cloudflare resources.
- [Terraform Provider for Cloudflare](https://github.com/cloudflare/terraform-provider-cloudflare) - Official Terraform provider for Workers and Cloudflare resources.
...
- [Reference Architecture Diagrams](https://developers.cloudflare.com/reference-architecture/diagrams/) - Architecture patterns and design guidance for serverless applications and storage.
